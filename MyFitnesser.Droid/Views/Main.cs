namespace MyFitnesser {
  ...
  internal class MainActivity : Activity {
    ...
    protected override void OnStart() {
      ...
      SetLeftPanel(Core.FragmentType.CalendarForm, Guid.Empty);
    ...
    public void SetLeftPanel(Core.FragmentType type, Guid id) {
      switch (type) {
        case Core.FragmentType.ClientForm:
          ...
          break;
        case Core.FragmentType.CalendarForm:
          FragmentManager.BeginTransaction().Add(Resource.Id.panel_left, new CalendarForm()).Commit();
          break;
    ...
    public void SetRightPanel(Core.FragmentType type, Guid id) {
      ...
      switch (type) {
        case Core.FragmentType.ClientForm:
          ...
          break;
        case Core.FragmentType.CalendarForm:
          FragmentManager.BeginTransaction().Add(Resource.Id.panel_right, new CalendarForm()).Commit();
          break;
        case Core.FragmentType.ClientsList:
          // TODO
          break;
